<html>
	...
	<body>
		<div id="zaglavlje">
			...
			<div id="meni">
				<a href="Glavna.php" style="text-decoration:none;"><div id="neodabrano"><h1>POČETNA</h1></div></a>
				...
				<a href="O nama.php" style="text-decoration:none;"><div id="trenutno_odabrano"><h1>O NAMA</h1></div></a>
			</div>
		</div>		
	</body>
